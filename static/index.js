        ...
        postsArray.insertAdjacentHTML('beforeend',
            `<div class="post" data-index="${i}">
                ...
                <div class="post__options">
                    <img src="../static/nostar.png" alt="star image" class="star">
...
postsArray.addEventListener("click", event => {
    ...
    if (String(event.target.classList).includes("star")){
        starImage.outerHTML =  `<img src="../static/${starImage.outerHTML.includes("nostar") ? '': "no"}star.png" alt="star image" class="star">`
    }
})
